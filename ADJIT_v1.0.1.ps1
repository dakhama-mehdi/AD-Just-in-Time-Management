...
# Fonction pour afficher la fenêtre de sélection d'utilisateur
...
"@
    ...
    $global:selectedUser = $null  # Réinitialisation avant l'affichage
    ...
    $lstUsers.Add_MouseDoubleClick({
        ...
        $UserWindow.DialogResult = $true  # Confirmer une sélection
        $UserWindow.Close()
    })
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Background="White">
        <StackPanel HorizontalAlignment="Center" VerticalAlignment="Center">
            ...
            <TextBlock Text="Version 1.0" FontSize="14" Foreground="Gray" TextAlignment="Center" Margin="0,5,0,5"/>
...
$menuExit.Add_Click({
    $Window.Close()  # Ferme la fenêtre principale
})
